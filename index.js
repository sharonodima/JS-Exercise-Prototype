...
Baby.prototype.play = function() {
  return `Playing withb${this.favoriteToy}`;
}

/* 
  TASK 4
  In your own words explain the four principles for the "this" keyword below:
  1. Windoew/ Global Object Binding - when none of the other rules apply, this will reurn the window or global object in node or undefied in strict mode.
